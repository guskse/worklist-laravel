<x-layout>
    ...
    <div class="bg-white rounded-lg shadow-md w-full md:max-w-xl mx-auto mt-12 p-8 py-12">
        ...
        <form action="{{route('register.store')}}" method="POST">
            ...
            {{-- to avoid page expired error 319, add @csrf --}}
            @csrf
            ...
            <x-inputs.text id="password_confirmation" name="password_confirmation" placeholder="Confirm password" type="password" />
            ...
            <p class="mt-4 text-gray-500">Already have an account?
                <a href="{{route('login')}}" class="text-blue-900">Login</a> instead.
            </p>
